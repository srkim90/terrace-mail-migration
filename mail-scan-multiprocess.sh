...
print_help() {
    ...
    echo '================================================================================================================'
    echo ' [USAGE]'
    echo '  ./mail-scan-multiprocess.sh                                                                 # 모든 메일 스켄, 임의저장'
    echo '  ./mail-scan-multiprocess.sh [scan-data-save-directory] [end-day] [start-day] [company-id]   # 날짜범위 & 지정된 회사'
    echo '  ./mail-scan-multiprocess.sh [scan-data-save-directory] [end-day] [start-day]                # 날짜범위'
    echo '  ./mail-scan-multiprocess.sh [scan-data-save-directory] [list-of-company-id]                 # 지정된 회사'
    echo '----------------------------------------------------------------------------------------------------------------'
    echo ' [EXAMPLE]'
    echo '  ./mail-scan-multiprocess.sh report_20221014_142059 2022-10-14 2020-01-01 10,11,12,13,14'
    echo '  ./mail-scan-multiprocess.sh report_20221014_142059 2022-10-14 2020-01-01'
    echo '  ./mail-scan-multiprocess.sh report_20221014_142059 10'
    echo '  ./mail-scan-multiprocess.sh'
    echo '----------------------------------------------------------------------------------------------------------------'
    echo ' [CONFIGURATION]'
...
execute_python() {
    $PYTHON ${BASE_DIR}/main/mail_scanner_multiprocess.py $@
}
